...
<div id="content">
  ...
  <a href="displayNews.php">News</a> | 
    <a href='userRegistrationForm.php'>New User </a> | <a href='loginForm.php'> Login </a>
	<br>
	<br>
  </div><!--end of newLoginDiv--> 
 ...
 <?php 
   ...
   $rsCat=mysqli_query($connect,"select * from category_info where cat_parent_id=$prid order by cat_dname");
...
<?php 
   ...
   $rsItem=mysqli_query($connect,"select * from item_info where parent_category=$prid order by item_name");
